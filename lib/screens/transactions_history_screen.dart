...
class TransactionsHistoryScreen extends StatelessWidget {
  ...
  /// 🔹 Build a combined list of transactions for a given user
  List<Map<String, dynamic>> _buildTransactions(
      JobProvider provider, String userName) {
    final List<Map<String, dynamic>> transactions = [];
  ...
  Widget _buildTransactionTile(BuildContext context, Map<String, dynamic> tx) {
    ...
    return ListTile(
      leading: Icon(getIcon(), color: getAmountColor()),
      title: Text(
        tx['title'],
        maxLines: 2,
        overflow: TextOverflow.ellipsis,
